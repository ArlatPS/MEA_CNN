...
N_zeros = 190
N_zeros_to_test = 35
zeros_tst = np.zeros((N_zeros_to_test, 1, 3600))
ZT_count = -1;
new_zeros = np.zeros((N_zeros - N_zeros_to_test, 1,3600))
NZ_count = -1
...
N_ones = 31;
N_ones_to_test = 14;
ones_tst = np.zeros((N_ones_to_test, 1,3600))
ZT_count = -1;
new_ones = np.zeros((N_ones - N_ones_to_test, 1,3600))
NZ_count = -1
